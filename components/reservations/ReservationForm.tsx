  ...
  return (
    <form onSubmit={submit} className="reservation-form">
      <div className="grid gap-x-6 gap-y-5 md:grid-cols-2">
        ...
        <label className="field-label">Alternate date <span className="normal-case text-slate-400">(optional)</span>
        ...
        <label className="field-label">Pickup point <span className="normal-case text-slate-400">(optional)</span>
          <input name="pickupPoint" className="input mt-2" placeholder="Pokhara, Kathmandu, hotel..." />
        </label>

        <div className="my-2 border-t border-ink/10 md:col-span-2" />

        <label className="field-label">Name
          <input name="customerName" autoComplete="name" className="input mt-2" required />
        </label>
        <label className="field-label">Phone / WhatsApp
          <input name="customerPhone" autoComplete="tel" className="input mt-2" required />
        </label>
        ...
        <label className="field-label md:col-span-2">Notes <span className="normal-case text-slate-400">(optional)</span>
